...
public class MainEmpresaAgroalimentaria {
  public static void main(String[] args) {
    ...
    // Crea un objeto de la clase ProductosFrescos y lo inicializa utilizando el
    // constructor
    ...
    congeladosPorAgua = new CongeladosPorAgua("Guisante Congelados", "2023-08-19", "ES76831",
        "IT", "2023-04-21", 4, 3);
    empresa.addProductosCongelados(congeladosPorAgua);

    CongeladosPorAire congeladosPorAire = new CongeladosPorAire("Guisante Congelados", "2023-09-10", "ES827931",
        "IT", "2023-05-26", 3, 3, 4, 3 ,4);
    empresa.addProductosCongelados(congeladosPorAire);

    congeladosPorAire = new CongeladosPorAire("Guisante Congelados", "2023-07-15", "ES823431",
        "ES", "2023-04-21", 3, 4, 5, 3 ,4);
    empresa.addProductosCongelados(congeladosPorAire);

    CongeladosPorNitro congeladosPorNitro = new CongeladosPorNitro("Guisante Congelados", "2023-09-10", "ES827931",
